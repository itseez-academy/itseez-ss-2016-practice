...
## Общая последовательность действий
  ...
  1. Решить все задачи, представленные в разделе [Основные задачи][tasks]. По мере
...
из репозитория `itseez-ss-2016-practice`.
  ...
  1. По аналогии следует запустить тесты `test_summer_school_2016.exe`. В результате
     прохождения тестов появится список тестов и статус подобно тому, что показан ниже.
