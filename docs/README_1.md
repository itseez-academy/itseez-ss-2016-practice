...
__Основные задачи__
  ...
  1. Настроить локальную копию репозитория для последующей синхронизации
     версии с сервером.
  1. Реализовать функцию отсечения элементов двумерного массива типа `uchar`.
  ...
  1. Отправить Pull Request в основной репозиторий, содержащего
     практические задания школы.

__Дополнительные задачи__

  1. Реализовать функцию усреднения элементов в заданной окрестности
     элемента. Например, если `src[i, j]` - исходное значение элемента
...
## Общая последовательность действий
  ...
  1. Реализовать функцию отсечения элементов двумерного массива типа `uchar`. По мере
     готовности не забывайте выкладывать изменения в рабочую ветку на сервер.
  1. Разработать тесты для реализованной функции отсечения.
...
из репозитория `itseez-ss-2016-practice`.
  ...
  1. Откройте сгенерированный файл решения `summer_school_2016.sln`. В терминал-классах
     Microsoft Visual Studio располагает по пути:
...
## Детальная инструкция по выполнению работы
  ...
  1. Собрать проект и проверить его работоспособность, запустив тесты и пример
     ...
     1. Чтобы проверить работоспособность тестов, достаточно запустить
        ...
        "зеленые", то можно двигаться дальше.
  ...
  1. Создать рабочую ветку (раздел [Общие инструкции по работе с Git][git-intro]).
  1. Реализовать метод отсечения элементов двумерного массива типа `uchar`.
